![npm](https://img.shields.io/npm/v/@taktikorg/repellendus-praesentium.svg)
![GitHub](https://img.shields.io/github/license/onubo/@taktikorg/repellendus-praesentium.svg)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/onubo/@taktikorg/repellendus-praesentium/issues)

# @taktikorg/repellendus-praesentium
...
![console log demo](https://raw.githubusercontent.com/onubo/@taktikorg/repellendus-praesentium/master/demo/demo-@taktikorg/repellendus-praesentium.png)
...
```sh
npm install --save @taktikorg/repellendus-praesentium
```

OR

```sh
yarn add @taktikorg/repellendus-praesentium
```

OR

```sh
expo install @taktikorg/repellendus-praesentium
```

## Quick Start

```javascript
import { logger } from "@taktikorg/repellendus-praesentium";
...
```javascript
import { logger, consoleTransport } from "@taktikorg/repellendus-praesentium";
...
```javascript
import { logger, transportFunctionType } from "@taktikorg/repellendus-praesentium";
...
```javascript
import { logger, fileAsyncTransport } from "@taktikorg/repellendus-praesentium";
...
@taktikorg/repellendus-praesentium includes some preset transports. You can import the one of your choice:
`import { logger, <transportName> } from '@taktikorg/repellendus-praesentium';`

#### Example

```javascript
import { logger, mapConsoleTransport } from "@taktikorg/repellendus-praesentium";
...
```javascript
import { logger, sentryTransport } from "@taktikorg/repellendus-praesentium";
...
All calls to `console.*` will then be handled by your @taktikorg/repellendus-praesentium logger and then you can manage their visibility via severity, or change their transports.
...
// all of the following console calls will use your @taktikorg/repellendus-praesentium logger
...
import {
  ...
  consoleTransport,
  fileAsyncTransport,
} from "@taktikorg/repellendus-praesentium";
import RNFS from "react-native-fs";
